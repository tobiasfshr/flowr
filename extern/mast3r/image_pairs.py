...
def make_pairs(imgs, scene_graph='complete', prefilter=None, symmetrize=True, sim_mat=None, keyframes=None):
    pairs = []
    if scene_graph == 'complete':  # complete graph
        ...
        fps_pairs, anchor_idxs = make_pairs_fps(sim_mat, Na=int(Na), tokK=int(k), dist_thresh=None, keyframes=keyframes)
